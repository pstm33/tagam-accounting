...
const P = {
  ...
  burgerSauce: "House burger sauce",
  salmon: "Salmon fillet",
  sushiRice: "Sushi rice raw",
  nori: "Nori sheet",
  ...
  lettuce: "Lettuce",
  pickles: "Pickles",
  blackBun: "Black burger bun",
  veganPatty: "Vegan patty",
  potatoFries: "Potato fries",
  ...
  oyster: "Oyster sauce",
  sweetChili: "Sweet chili sauce",
  miso: "Miso paste",
  dashi: "Dashi powder",
  wakame: "Wakame",
  tofu: "Tofu",
  tomYum: "Tom yum paste",
  ...
  carrot: "Carrot",
  cabbage: "Cabbage",
  saladGreens: "Salad greens",
  caesarSauce: "Caesar sauce",
  parmesan: "Parmesan",
  croutons: "Croutons",
  feta: "Feta cheese",
